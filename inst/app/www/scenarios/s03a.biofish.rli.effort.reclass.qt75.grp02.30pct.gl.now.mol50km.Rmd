...
#add rli for all species
  rli_all <- get_gmbi_grpsmdl_prjres("groups00", prjres) %>% 
...
- Planning unit cost:
    - fishing effort (KWH) with cells <112,775 (lowest 75%) KWH set to 0 (i.e. only top 25% of effort in cost layer)
...
- Feature targets:
    ...
    - Biodiversity:
        ...
        - `rli_all`: Red List Index of extinction risk from AquaMaps for all species [_now_]
    - Physical:
