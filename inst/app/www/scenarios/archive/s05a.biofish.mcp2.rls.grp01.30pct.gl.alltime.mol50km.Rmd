...
- Planning unit cost:
    - maximum catch potential: average MCP (2004 and 2050) with cells <3.481066 (lowest 75%) set to 0 (i.e. top 25% of mean MCP included in cost layer)
...
# cost layer: mean MCP (2004 and 2050) --
  s_fish_saup_alltime_mean <- get_d_prjres("s_fish_saup_v2",prjres)%>% 
    mean( ) %>% 
    reclassify(,rcl=cbind(-Inf, 3.481066 , 0), right=FALSE)

# apply cost to planning units
   r_pu <- s_fish_saup_alltime_mean
