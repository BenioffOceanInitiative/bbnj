...
- Planning unit cost:
    - maximum catch potential (2004) (rescaled 0-1)
...
# cost layer: max catch potential 2040 ----
 r_fish_saup_2004<- get_d_prjres("s_fish_saup_v2",prjres)%>%
    subset("mcp_2004")

# apply cost to planning units
  r_pu <- r_fish_saup_2004 %>% 
   # gap_fill_raster()
   rescale_raster(log=F)
