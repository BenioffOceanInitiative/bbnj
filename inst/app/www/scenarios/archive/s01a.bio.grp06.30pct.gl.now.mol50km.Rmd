...
if (!file.exists(tif) | redo){
  ...
  s_bio_gmbi <- get_gmbi_grpsmdl_prjres("groups06", "_mol50km")
  #plot(s_bio_gmbi)
...
- Feature targets:
    ...
    - Biodiversity:
        ...
        - `nspp_*`: number of species by taxonomic group from AquaMaps [_now_] filtered by species with >25% of its range in the high seas
