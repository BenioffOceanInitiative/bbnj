...
- Planning unit cost:
    - fishing profitability (with subsidies), ie minimize impacts to fishing
...
Note: Does not include maximum catch potential data. TODO: try MCP (now + future) as feature target (both inverse & regular target)
...
# cost layer: fishing profitability ----
 r_fish_profits<- get_d_prjres("s_fish_gfw",prjres)%>% 
