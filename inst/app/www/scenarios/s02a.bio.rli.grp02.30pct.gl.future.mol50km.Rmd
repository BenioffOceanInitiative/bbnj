...
- Feature targets:
    ...
    - **Biodiversity:
        ...
        - `nspp_*`: number of species by taxonomic group (group 2) from AquaMaps [_future_]
        - `rli_all`: Red List Index of averge extinction risk for all species from AquaMaps [_future_]
    - Physical:
