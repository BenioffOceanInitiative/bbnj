...
#rmd <- file.path(getwd(), "s01b.bio.10pct.rg.now.Rmd")
pfx <- rmd %>% fs::path_ext_remove()
```

# `r basename(pfx)`

Obtain 30% for each biodiversity and habitat target in the high seas with regional representation of the Seven Seas.
